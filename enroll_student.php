...
?>
    ...
    <div class="main-content">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Enroll Students</h4>
      ...
      <div class="d-flex justify-content-start mt-4 mb-4">
            <a href="add_student.php" class="btn btn-lg btn-outline-success">
      ...
      <table id="example" class="display" style="width:100%; background: white;">
        ...
        <tbody>
            <?php 
            $fetchStudents = mysqli_query($config,"SELECT * FROM students_directory");
            while ($row = mysqli_fetch_assoc($fetchStudents)) { ?>
            <tr>
                <td><?php echo $row['id']; ?></td>
                <td><img src="<?php echo $row['students_image']; ?>" class="rounded float-start" alt="..." height="140"></td>
                <td><a href="edit_student.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Edit</a></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="delete_student.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Yes, Delete</a>
      </div>
    </div>
  </div>
</div>
